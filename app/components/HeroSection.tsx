  ...
  return (
    <section className="py-16 md:py-28 max-w-7xl mx-auto px-5 md:px-8 grid grid-cols-12 gap-8 md:gap-6">
      <div className="col-span-12 md:col-span-8">
        ...
        <motion.p {...fadeUp(0.18, shouldReduceMotion)} className="text-lg md:text-2xl font-medium text-secondary mb-4 md:mb-6 tracking-[-0.015em]">
          Founder Minded, AI Native Product Owner
        </motion.p>
        <motion.p
          {...fadeUp(0.28, shouldReduceMotion)}
        ...
        <motion.div {...fadeUp(0.36, shouldReduceMotion)} className="flex flex-wrap gap-3 md:gap-4">
          <a
            href="#work"
      ...
      <motion.div
        ...
        transition={{ duration: shouldReduceMotion ? 0.2 : 0.6, delay: shouldReduceMotion ? 0 : 0.12, ease }}
